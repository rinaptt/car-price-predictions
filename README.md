...
Для тестирования приложения можно использовать CSV файл, содержащий 5 случайно выбранных строк из тестового набора данных (_.data/example_car_prices.csv_).

Веб-приложение доступно по [ссылке](https://car-price-pred-glwjw7wmcfwc22cccc8mad.streamlit.app/).
